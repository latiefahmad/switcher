...
### 🚀 Installation
1. Download the latest VSIX file: [github-profile-switcher-1.8.2.vsix](https://github.com/latiefahmad/switcher/releases/download/v1.8.2/github-profile-switcher-1.8.2.vsix) (or visit [GitHub Releases](https://github.com/latiefahmad/switcher/releases)).
...
4. Choose the downloaded `github-profile-switcher-1.8.2.vsix` file.
...
### 🚀 Cara Install
1. Download file VSIX versi terbaru: [github-profile-switcher-1.8.2.vsix](https://github.com/latiefahmad/switcher/releases/download/v1.8.2/github-profile-switcher-1.8.2.vsix) (atau kunjungi halaman [GitHub Releases](https://github.com/latiefahmad/switcher/releases))
...
4. Pilih file `github-profile-switcher-1.8.2.vsix` yang telah didownload.
